...
@app.callback(
    ...
    [Input(component_id='dropdown-statistics', component_property='value'), Input(component_id='select_year', component_property='value')])


def update_output_container(report_type, data):
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(
            figure=px.line(yas,
                           x='Year',
                           y='Automobile_Sales',
                           title='Yearly Automobile Sales from 1980-2023'))
