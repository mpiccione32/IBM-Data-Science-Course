...
@app.callback(
      Output('input_year', 'disabled'), #changed select-year to input_year
      Input('selected_statistics','value'))
...
@app.callback(
    ...
    Input(component_id='input_year', component_property='value') ]) #changed select_year to input_year
